...
<body>
    <div class="container-fluid">
        ...
        <div class="row justify-content-md-center">
            <form method="POST" action="../PHP/sabeMateria.php" enctype="multipart/form-data">
        ...
        <table class="table table-striped table-hover">
            ...
            if ($resultado->num_rows > 0) {
                ...
                echo "<tr><td colspan='2' class='centrar'>NO EXISTEN DATOS</td></tr>";
            }
